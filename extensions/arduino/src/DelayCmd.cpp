...
std::pair<int, Cmd> DelayCmd::Compile(Program& prog, Func& func, const std::vector<std::string>& args)
{
    Cmd cmd{};
    cmd.name = "delay";
    cmd.args = args;
...
void DelayCmd::Generate(Program& prog, Func& func, Cmd& cmd, std::ofstream& out)
{
