...
std::pair<int, Cmd> VarCmd::Compile(Program& prog, Func& func, const std::vector<std::string>& args)
{
    Cmd cmd{};
    cmd.name = "var";
    cmd.args = args;
...
void VarCmd::Generate(Program& prog, Func& func, Cmd& cmd, std::ofstream& out)
{
